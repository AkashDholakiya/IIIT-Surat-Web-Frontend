...
function AboutTnp_Tnp_Officer() {
  return (
    ...
    <div className="mt-16 max-md:mt-10 max-md:max-w-full">
      <div className="flex gap-5 max-md:flex-col max-md:gap-0">
        <div className="flex flex-col w-[23%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col text-blue-500 max-md:mt-10">
            <div className="self-start ml-6 text-2xl font-semibold max-md:ml-2.5">
              About Tnp cell
            </div>
            <div className="flex gap-4 mt-5">
              <img
                ...
                className="shrink-0 w-2 border-8 border-blue-500 border-solid aspect-[0.11] stroke-[8px] stroke-blue-500"
              alt="tmp-prfole-image" />
              <div className="flex flex-col grow shrink-0 my-auto basis-0 w-fit">
                <div className="text-2xl font-semibold">T&P officer</div>
                <div className="mt-4 text-xl font-medium">
                  Dr. Vijaykumar Radadiya
                </div>
              </div>
            </div>
            <div className="flex flex-col mt-7 text-2xl font-semibold">
              <div>Placement Team</div>
              <div className="mt-4 text-xl font-medium">
                Working for better future
              </div>
              <div className="mt-8 max-md:mr-2.5">Placement Statistics</div>
              <div className="mt-4 text-xl font-medium">
                Well equipped 3 labs{" "}
              </div>
              <div className="mt-8">Our Achievers</div>
              <div className="mt-4 text-xl font-medium">
                Alumni work in top MNC
              </div>
              <div className="mt-8">Placement Guidelines</div>
              <div className="mt-4 text-xl font-medium">Our Recruiters</div>
            </div>
          </div>
        </div>
          ...
          <div className="grow mt-8 max-md:mt-10 max-md:max-w-full">
            <div className="flex gap-5 max-md:flex-col max-md:gap-0">
              ...
              <div className="flex flex-col ml-5 w-[71%] max-md:ml-0 max-md:w-full">
                <div className="flex flex-col grow mt-2.5 text-3xl font-semibold text-blue-500 max-md:mt-10 max-md:max-w-full">
                  <div className="max-md:max-w-full">
                    Dr. Vijaykumar Radadiya
                  </div>
                  <div className="mt-5 leading-6 max-md:max-w-full">
                  ...
                  <div className="mt-2.5 text-xl italic font-medium max-md:max-w-full">
                    tnpoffice@iiitsurat.ac.in
                  </div>
                  <div className="mt-8 text-2xl font-medium max-md:max-w-full">
    ...
    <div className="self-center mt-14 text-4xl font-semibold leading-9 text-emerald-500 max-md:mt-10 max-md:max-w-full flex justify-end">
      Words from T&P Officer
    </div>
    <div className="self-end mt-9 text-2xl text-justify text-blue-500 max-md:max-w-full mt-11 p-4 ">
      ...
      dignissimos, vitae debitis ad alias nisi.
      <br />
      <br />
      Lorem ipsum dolor sit amet consectetur, adipisicing elit. Doloribus
      obcaecati magni voluptates nihil iure quaerat optio minima, totam ipsum
