...
import InstituteCommittees from "./Pages/committee";

//CSE
import CSE from "./Pages/CSE/cse";
import AboutCse from "./Pages/CSE/about";
import FacultyCse from "./Pages/CSE/faculty";
import LaboratoryCse from "./Pages/CSE/lab";
import ResearchScholarsCse from "./Pages/CSE/scholar";
import CSESyllabus from "./Pages/CSE/syllabus";
// import CurriculumCse from "./Pages/CSE/curriculum";

//ECE
import ECE from "./Pages/ECE/ece";
import AboutECE from "./Pages/ECE/about";
import FacultyECE from "./Pages/ECE/faculty";
import LaboratoryECE from "./Pages/ECE/lab";
import ResearchScholarsECE from "./Pages/ECE/scholar";
import ECESyllabus from "./Pages/ECE/syllabus"; 

//ASH
import ASH from "./Pages/ASH/ash";
import AboutASH from "./Pages/ASH/about";
import FacultyASH from "./Pages/ASH/faculty";
import LaboratoryASH from "./Pages/ASH/lab";
import ResearchScholarsASH from "./Pages/ASH/scholar";

import AdjunctFaculty from "./Pages/adjunct";
import ProfessorOfPractice from "./Pages/profofpractice";
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route path="/cse" element={<CSE />}>
            ...
            <Route path="about" element={<AboutCse />} />
            <Route path="faculty" element={<FacultyCse />} />
            <Route path="lab" element={<LaboratoryCse />} />
            <Route path="scholar" element={<ResearchScholarsCse />} />
            <Route path="syllabus" element={<CSESyllabus />} />
          </Route>

           <Route path="/ece" element={<ECE />}>
            <Route index element={<ECE />} />
            <Route path="about" element={<AboutECE />} />
            <Route path="faculty" element={<FacultyECE />} />
            <Route path="lab" element={<LaboratoryECE />} />
            <Route path="scholar" element={<ResearchScholarsECE />} />
            <Route path="syllabus" element={<ECESyllabus />} />
          </Route>

          <Route path="/ash" element={<ASH />}>
            <Route index element={<ASH />} />
            <Route path="about" element={<AboutASH />} />
            <Route path="faculty" element={<FacultyASH />} />
            <Route path="lab" element={<LaboratoryASH />} />
            <Route path="scholar" element={<ResearchScholarsASH />} />
          </Route>


          <Route path='/adjunct-professor' element={<AdjunctFaculty />} />
          <Route path='/professor-of-practice' element={<ProfessorOfPractice />} />
          ...
          <Route path="faculty/:facultyId" element={<Faculty />} />
           ...
           {/* <Route path="/cse" element={<CSE />}>
            <Route index element={<CSE />} />
            <Route path="hod" element={<Calender />} />
            <Route path="faculty" element={<Holiday />} />
            <Route path="laboratory" element={<Btech />} />
            <Route path="curriculum" element={<Phdrules />} />
            <Route path="research-scholars" element={<Phdrules />} />
          </Route> */}
          ...
          <Route path="/committee" element={<InstituteCommittees />} />
          {/* <Route path="/admission" element={<Admission />} /> */}
