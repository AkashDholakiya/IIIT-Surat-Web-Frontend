...
function App() {
  ...
  const [pdfFile, setPdfFile] = useState("/images/Physical_Reporting_B.Tech_2024_25.pdf");
  ...
  // List of PDF links
  const pdfLinks = [
    { name: "Physical Reporting for B.Tech. Programme", file: "/images/Physical_Reporting_B.Tech_2024_25.pdf" },
    { name: "Seat Matrix for 2025-26", file: "/images/Seat_Matrix_2024_25.pdf" },
    { name: "Fee Structure 2025-26", file: "/images/Fee_Structure_2023-24.pdf" },
    { name: "Schedule Of Events Of JoSAA (ONLINE REPORTING) 2025-26", file: "/images/CSAB_Special_Round_Schedule_2025.pdf" },
    { name: "Business Rules For Joint Seat Allocation 2025-26", file: "/images/JoSAA-Business-Rules.pdf" },
  ];
