...
const links = [
  { key: 'about', label: "About Department", path: '/ash/about' },
  { key: 'faculty', label: "Faculty", path: '/ash/faculty' },
  { key: 'lab', label: "Laboratory", path: '/ash/lab' },
  { key: 'research-scholar', label: "Research Scholar", path: '/ash/scholar' }
];
