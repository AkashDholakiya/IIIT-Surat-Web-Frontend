...
const links = [
  { key: 'about', label: "About Department", path: '/cse/about' },
  { key: 'faculty', label: "Faculty", path: '/cse/faculty' },
  { key: 'lab', label: "Laboratory", path: '/cse/lab' },
  { key: 'syllabus', label: "Curriculum", path: '/cse/syllabus' },
  { key: 'research-scholar', label: "Research Scholar", path: '/cse/scholar' }
];
