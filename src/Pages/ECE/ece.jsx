...
const links = [
  { key: 'about', label: "About Department", path: '/ece/about' },
  { key: 'faculty', label: "Faculty", path: '/ece/faculty' },
  { key: 'lab', label: "Laboratory", path: '/ece/lab' },
  { key: 'syllabus', label: "Curriculum", path: '/ece/syllabus' },
  { key: 'research-scholar', label: "Research Scholar", path: '/ece/scholar' }
];
