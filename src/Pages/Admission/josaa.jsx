...
import josaa_pdf from "../../assets/Admission/coming_soon.pdf";
...
>Schedule Of Events Of JoSAA (ONLINE REPORTING) 2025-26</h1>
          ...
          <section className="flex flex-col w-full px-0 md:px-5">
            <div className="flex flex-col items-center w-full gap-5">
              ...
              <div className="w-full">
                <iframe
                  src={josaa_pdf}
                  title="Schedule Of Events Of JoSAA (ONLINE REPORTING) 2025-26"
