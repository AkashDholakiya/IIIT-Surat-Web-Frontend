...
import business_pdf from "../../assets/Admission/coming_soon.pdf";
...
>Business Rules For Joint Seat Allocation 2025-26</h1>
          ...
          <section className="flex flex-col w-full px-0 md:px-5">
            <div className="flex flex-col items-center w-full gap-5">
              ...
              <div className="w-full">
                <iframe
                  src={business_pdf}
                  title="Business Rules for Joint Seat Allocation 2025-26"
