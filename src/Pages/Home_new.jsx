  ...
  return (
    <div>
      ...
      <div className='p-10 max-lg:p-5 max-lg:py-10'>
        ...
        {loadingAnnouncements ? (
          <div className="flex justify-center items-center mt-10 h-24">
            <p className="text-[#660000]">Loading announcements...</p>
          </div>
        ) : announcementError ? (
          <div className="flex justify-center items-center mt-10 h-24">
                  ...
                  {[0, 1].map((rowIndex) => {
                    ...
                    return (                      
                      <Link
                        ...
                        target='_blank'
                        className={`flex flex-col p-2 w-96 h-24 mr-5 rounded-lg border border-[#660000] cursor-pointer ${rowIndex === 1 ? 'mt-8' : ''}`}
                      >
                        <div className="flex flex-col justify-between h-full">
                          <h1 className='text-sm font-semibold text-[#660000] line-clamp-2 overflow-hidden text-ellipsis'>
                            {announcement.title}
                          </h1>
                          <div className='flex w-full justify-start text-xs mt-auto'>
      ...
      <div className="px-10 max-lg:px-5 py-5">
        ...
        {loadingEvents ? (
          <div className="flex justify-center items-center mt-10 h-24">
            <p className="text-[#660000]">Loading events...</p>
          </div>
        ) : eventError ? (
          <div className="flex justify-center items-center mt-10 h-24">
          ...
          <div className='flex overflow-x-auto mt-10'>
            {events.map((event, index) => (
              <div key={index} className='flex flex-col p-1 w-96 mr-5'>
                <div className="relative w-96">
                  <img src={event.image || "/images/sample-2.svg"} alt="event" />
                  <div className='text-[#003481] bg-[#FFFFFF] py-1 px-4 rounded-full absolute top-1.5 text-xs left-2'>
                ...
                <div className="px-5 w-full mt-5">
                  <h1 className='text-medium font-semibold text-[#660000] line-clamp-2'>{event.title}</h1>
                  <p className="mt-4 text-[#474747]">
                    {event.description}
                    <Link to={event.link ? `${backend_local}${event.link}` : '#'} target="_blank" className='font-semibold underline cursor-pointer'> Read More</Link>
                  </p>
                </div>
              </div>
            ))}
