    ...
    <div>
        ...
        <div className='p-10'>
            <div className='flex flex-col border-l-4 border-[#660000] text-[#660000] pl-4'>
                <p className='font-semibold text-2xl'>Important Announcements and notification</p>
        ...
        <div className="px-10 py-5">
            <div className='flex flex-col border-l-4 border-[#660000] text-[#660000] pl-4'>
                <p className='font-semibold text-2xl'>Latest updates and achievements</p>
                <p>Lorem ipsum, dolor sit amet consecte adipisicing elit Asperiores.</p>
            </div>
        ...
        <div className="mt-56 h-[40rem] relative">
        ...
        <div className="my-16 px-10">
            ...
            <div className="mt-5 grid grid-rows-2 grid-cols-4 gap-3">
              <div className='relative bg-contain bg-center bg-no-repeat h-52 rounded-2xl text-white' style={{backgroundImage:"linear-gradient(to bottom, rgba(255, 255, 255, 0.1), rgba(0, 0, 0, 0.9)), url('/images/sample_last_second.svg')"}}>
        ...
        <div className="my-10 w-full">
            <h1 className='text-center text-[#660000] font-bold text-xl'>MoE Initiatives</h1>
            <div className="mt-8 flex justify-center">
              <div className='flex items-center mr-10'>
                <img src="/images/moe/img-1.svg" alt="1"/>
                <p className='text-[#003481] text-lg ml-3 font-semibold'>Ek bharat <br /> Shresth bharat</p>
              </div>
              <div className='flex items-center mr-10'>
                <img src="/images/moe/img-2.svg" alt="1"/>
              ...
              <div className='flex items-center'>
                <img src="/images/moe/img-3.svg" alt="1"/>
                <div className="flex flex-col ml-3">
